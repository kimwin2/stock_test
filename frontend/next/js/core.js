...
(function (global) {
  ...
  var SUPPLY_LEVELS = [
    { label: '강한 빈집', desc: '외인·기관이 거의 없다' },
    { label: '빈집',      desc: '외인·기관이 아직 안 들어왔다' },
    { label: '중간',      desc: '매수세가 들어오는 중' },
    { label: '찼음',      desc: '외인·기관이 들어왔다' },
    { label: '강한 찼음', desc: '외인·기관이 다 채웠다' }
  ];
  ...
  var GLOSSARY = {
    vacancy: {
      ...
      how: '부호가 아니라 감속으로 봅니다. 5일 순매수가 플러스여도 20일 페이스보다 느려졌으면 빈집입니다. 큰손이 아직 다 담지 않은 자리를 먼저 보려는 것입니다.'
    },
    depth: {
      t: '빈집 깊이',
    ...
    osc: {
      ...
      how: '0 아래면 빈집, 위면 채워지는 중입니다. 절대 금액이 아니라 시총 대비라 대형주와 소형주를 같은 자로 잽니다.'
    },
    fg: {
      t: '공포·탐욕 지수',
    ...
    trend: {
      ...
      how: '빈집이어도 추세가 꺾였으면 후보에서 뺍니다. 싸다는 것과 살아 있다는 것은 다릅니다.'
    },
    cash: {
      t: '현금 비중',
    ...
    theme: {
      ...
      how: '이 탭은 “오늘 뭐가 왜 올랐나”만 말합니다. 수급 빈집 판정은 하지 않습니다 — 두 화면이 같은 종목을 다른 기준으로 말하면 안 되기 때문입니다.'
    }
  };
