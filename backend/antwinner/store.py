...
DEFAULT_SIGNAL_KEY = "signals/antwinner_themes_latest.json"
...
def _resolve_signal_key(signal_key: str | None = None) -> str:
    return (signal_key or os.getenv("ANTWINNER_SIGNAL_S3_KEY", DEFAULT_SIGNAL_KEY)).strip()
...
def save_antwinner_payload(
    ...
    print(f"[INFO] 개미승리 테마 데이터를 {target}에 저장했습니다.")
    return target
